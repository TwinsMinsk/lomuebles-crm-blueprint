  ...
  return (
    <div className="bg-slate-800 text-white py-6 px-4 rounded-lg shadow-lg mb-6">
      ...
      <div className="flex flex-col gap-3 text-sm">
        ...
        {/* Добавляем новые связи для order_items */}
        <div className="flex items-center text-slate-300">
          <span>order_items</span>
          <ArrowRight className="h-4 w-4 mx-2" />
          <span>deals_orders</span>
          <p className="ml-4 text-slate-400">(связь через поле parent_deal_order_id)</p>
        </div>
        
        {/* Добавляем новые связи для custom_requests */}
        <div className="flex items-center text-slate-300">
        ...
        <div className="flex items-center text-slate-300">
          ...
          <ArrowRight className="h-4 w-4 mx-2" />
          <span>deals_orders</span>
          <p className="ml-4 text-slate-400">(связь через поле linked_deal_order_id)</p>
        </div>
        ...
        {/* Добавляем новые связи для products */}
        <div className="flex items-center text-slate-300">
          <span>products</span>
          <ArrowRight className="h-4 w-4 mx-2" />
          <span>profiles</span>
