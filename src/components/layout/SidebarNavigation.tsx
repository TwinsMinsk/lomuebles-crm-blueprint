...
import { LayoutDashboard, Users, Building, Package, ListChecks, Calendar, ShoppingCart, Truck, Settings, UserCog } from "lucide-react";
...
const SidebarNavigation = () => {
  ...
  return <SidebarGroup className="bg-white my-[34px]">
