...
export const addOrder = async (orderData: OrderInput) => {
  // Using a cast to ensure TypeScript knows that even though order_number isn't in OrderInput,
  // Supabase will handle it correctly (it's auto-generated by a trigger)
