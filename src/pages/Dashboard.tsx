        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card>
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-gray-600 mt-4">В системе настроены таблицы профилей пользователей, лидов, компаний, контактов и партнеров-изготовителей с разграничением прав доступа.</p>
            </CardContent>
          </Card>
