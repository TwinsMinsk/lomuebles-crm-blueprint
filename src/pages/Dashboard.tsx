        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card>
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-gray-600 mt-4">В системе настроена таблица профилей пользователей с разграничением прав доступа.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="pt-4">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Настроена автоматическое создание профиля при регистрации</li>
              </ul>
            </CardContent>
          </Card>
        </div>
