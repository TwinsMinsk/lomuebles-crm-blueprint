...
INSERT INTO public.materials (
  ...
  ('Доска дубовая 40x200x2000', 'Дерево', 'штуки', 1500.00, 10, 100, 
  ...
  ('Лак акриловый прозрачный', 'Покрытия', 'литры', 850.00, 5, 50, 
   'Тестовое покрытие для проверки списаний', true, (SELECT id FROM profiles WHERE role = 'Главный Администратор' LIMIT 1)),
  ('Фанера березовая 18мм', 'Листовые материалы', 'листы', 2200.00, 15, 200, 
