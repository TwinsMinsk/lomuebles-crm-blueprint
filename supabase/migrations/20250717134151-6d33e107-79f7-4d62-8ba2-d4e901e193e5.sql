...
-- Create trigger to auto-calculate available_quantity (if not exists)
DROP TRIGGER IF EXISTS update_available_quantity_trigger ON public.stock_levels;
...
DROP TRIGGER IF EXISTS update_estimate_total_cost_trigger ON public.estimate_items;
