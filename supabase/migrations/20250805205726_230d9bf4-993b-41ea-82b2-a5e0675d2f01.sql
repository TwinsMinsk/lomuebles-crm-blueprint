-- Force fix all negative stock levels
...
-- Add CHECK constraints to prevent negative stock levels
...
-- Create validation function for stock movements
...
-- Create function to get available locations for a material
