...
-- Create RPC function for custom task sorting
...
BEGIN
  ...
  v_query := 'SELECT t.task_id, t.task_name, t.description, t.task_type, t.task_status, t.priority, ' ||
             ...
             't.related_custom_request_id, t.related_partner_manufacturer_id, ' || v_total_count || ' as total_count ' ||
             'FROM tasks t WHERE 1=1' || v_where_conditions || ' ' || v_order_clause ||
