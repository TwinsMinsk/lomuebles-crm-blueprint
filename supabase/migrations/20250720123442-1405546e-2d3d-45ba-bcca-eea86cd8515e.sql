-- Drop the existing trigger first with CASCADE to handle dependencies
DROP TRIGGER IF EXISTS update_stock_level_on_movement ON public.stock_movements CASCADE;
DROP FUNCTION IF EXISTS public.update_stock_level_on_movement() CASCADE;
